...
struct mydsp : public dsp {
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider5 = static_cast<FAUSTFLOAT>(246.94f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("frequence", &fVslider5, FAUSTFLOAT(246.94f), FAUSTFLOAT(3e+01f), FAUSTFLOAT(8.8e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow10 = fConst1 * static_cast<float>(fVslider8);
		float fSlow11 = static_cast<float>(fButton1);
		float fSlow12 = fConst1 * static_cast<float>(fVslider9);
		float fSlow13 = static_cast<float>(fButton2);
		float fSlow14 = fConst1 * static_cast<float>(fVslider10);
		float fSlow15 = static_cast<float>(fButton3);
		float fSlow16 = fConst1 * static_cast<float>(fVslider11);
		float fSlow17 = static_cast<float>(fButton4);
		float fSlow18 = 8.0f * static_cast<float>(fVslider12) + 1.0f;
		float fSlow19 = 1.0f / std::tan(fConst24 * (3e+03f * static_cast<float>(fVslider13) + 4e+02f));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp31 = std::min<float>(8e+02f, fConst0 / std::max<float>(3e+01f, std::min<float>(1e+03f, fSlow6 * fRec15[0])));
			fVec0[0] = fSlow7;
			fRec14[0] = fRec14[1] + static_cast<float>((fSlow7 - fVec0[1]) > 0.0f) - static_cast<float>(fRec14[1] > 0.0f) / fTemp31;
			fVec1[IOTA0 & 1023] = 0.985f * (fSlow9 * fRec12[1] + fSlow8 * fRec12[2]) + 4.656613e-10f * static_cast<float>(fRec14[0] > 0.0f) * fTemp30;
			fRec12[0] = fVec1[(IOTA0 - static_cast<int>(std::min<float>(8e+02f, std::max<float>(0.0f, fTemp31 + -1.0f)))) & 1023];
			fRec18[0] = fSlow10 + fConst2 * fRec18[1];
			float fTemp32 = std::min<float>(8e+02f, fConst0 / std::max<float>(3e+01f, std::min<float>(1e+03f, fSlow6 * fRec18[0])));
			fVec2[0] = fSlow11;
			fRec17[0] = fRec17[1] + static_cast<float>((fSlow11 - fVec2[1]) > 0.0f) - static_cast<float>(fRec17[1] > 0.0f) / fTemp32;
			fVec3[IOTA0 & 1023] = 0.985f * (fSlow9 * fRec16[1] + fSlow8 * fRec16[2]) + 4.656613e-10f * fTemp30 * static_cast<float>(fRec17[0] > 0.0f);
			fRec16[0] = fVec3[(IOTA0 - static_cast<int>(std::min<float>(8e+02f, std::max<float>(0.0f, fTemp32 + -1.0f)))) & 1023];
			fRec21[0] = fSlow12 + fConst2 * fRec21[1];
			float fTemp33 = std::min<float>(8e+02f, fConst0 / std::max<float>(3e+01f, std::min<float>(1e+03f, fSlow6 * fRec21[0])));
			fVec4[0] = fSlow13;
			fRec20[0] = fRec20[1] + static_cast<float>((fSlow13 - fVec4[1]) > 0.0f) - static_cast<float>(fRec20[1] > 0.0f) / fTemp33;
			fVec5[IOTA0 & 1023] = 0.985f * (fSlow9 * fRec19[1] + fSlow8 * fRec19[2]) + 4.656613e-10f * fTemp30 * static_cast<float>(fRec20[0] > 0.0f);
			fRec19[0] = fVec5[(IOTA0 - static_cast<int>(std::min<float>(8e+02f, std::max<float>(0.0f, fTemp33 + -1.0f)))) & 1023];
			fRec24[0] = fSlow14 + fConst2 * fRec24[1];
			float fTemp34 = std::min<float>(8e+02f, fConst0 / std::max<float>(3e+01f, std::min<float>(1e+03f, fSlow6 * fRec24[0])));
			fVec6[0] = fSlow15;
			fRec23[0] = fRec23[1] + static_cast<float>((fSlow15 - fVec6[1]) > 0.0f) - static_cast<float>(fRec23[1] > 0.0f) / fTemp34;
			fVec7[IOTA0 & 1023] = 0.985f * (fSlow9 * fRec22[1] + fSlow8 * fRec22[2]) + 4.656613e-10f * fTemp30 * static_cast<float>(fRec23[0] > 0.0f);
			fRec22[0] = fVec7[(IOTA0 - static_cast<int>(std::min<float>(8e+02f, std::max<float>(0.0f, fTemp34 + -1.0f)))) & 1023];
			fRec27[0] = fSlow16 + fConst2 * fRec27[1];
			float fTemp35 = std::min<float>(8e+02f, fConst0 / std::max<float>(3e+01f, std::min<float>(1e+03f, fSlow6 * fRec27[0])));
			fVec8[0] = fSlow17;
			fRec26[0] = fRec26[1] + static_cast<float>((fSlow17 - fVec8[1]) > 0.0f) - static_cast<float>(fRec26[1] > 0.0f) / fTemp35;
			fVec9[IOTA0 & 1023] = 0.985f * (fSlow9 * fRec25[1] + fSlow8 * fRec25[2]) + 4.656613e-10f * fTemp30 * static_cast<float>(fRec26[0] > 0.0f);
			fRec25[0] = fVec9[(IOTA0 - static_cast<int>(std::min<float>(8e+02f, std::max<float>(0.0f, fTemp35 + -1.0f)))) & 1023];
			float fTemp36 = tanhf(fSlow18 * (fRec25[0] + fRec22[0] + fRec19[0] + fRec16[0] + fRec12[0]));
			fVec10[0] = fTemp36;
			fRec11[0] = -(fSlow21 * (fSlow20 * fRec11[1] - (fTemp36 + fVec10[1])));
			...
			fRec28[0] = fSlow26 + fConst2 * fRec28[1];
			float fTemp37 = fRec28[0] * (fSlow25 * fRec0[IOTA0 & 2047] + fSlow24 * (0.4f * fRec0[(IOTA0 - 901) & 2047] + 0.37f * fRec0[(IOTA0 - 778) & 2047] + 0.33f * fRec0[(IOTA0 - 1011) & 2047]));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp37);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp37);
			fRec1[1] = fRec1[0];
			fRec3[1] = fRec3[0];
			fRec5[1] = fRec5[0];
			fRec7[1] = fRec7[0];
	...
	FAUST_ADDVERTICALSLIDER("KISANA_5_STRINGS/Corde_5/frequence", fVslider5, 246.94f, 3e+01f, 8.8e+02f, 0.1f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(VERTICALSLIDER, frequence, "KISANA_5_STRINGS/Corde_5/frequence", fVslider5, 246.94f, 3e+01f, 8.8e+02f, 0.1f) \
