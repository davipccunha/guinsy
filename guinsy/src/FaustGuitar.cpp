...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 1.0f / std::tan(314.15927f / fConst0);
		fConst6 = 1.0f - fConst5;
		fConst7 = 1.0f / (fConst5 + 1.0f);
		iConst8 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.025306122f * fConst0)) + -0.8f));
		iConst9 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.026938776f * fConst0)) + -0.8f));
		iConst10 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.028956916f * fConst0)) + -0.8f));
		iConst11 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.030748298f * fConst0)) + -0.8f));
		iConst12 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.0322449f * fConst0)) + -0.8f));
		iConst13 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.033809524f * fConst0)) + -0.8f));
		iConst14 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.035306122f * fConst0)) + -0.8f));
		iConst15 = static_cast<int>(std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.036666665f * fConst0)) + -0.8f));
		iConst16 = static_cast<int>(std::min<float>(1024.0f, std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.0126077095f * fConst0)) + -0.8f)));
		iConst17 = static_cast<int>(std::min<float>(1024.0f, std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.01f * fConst0)) + -0.8f)));
		iConst18 = static_cast<int>(std::min<float>(1024.0f, std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.0077324263f * fConst0)) + -0.8f)));
		iConst19 = static_cast<int>(std::min<float>(1024.0f, std::max<float>(0.0f, static_cast<float>(static_cast<int>(0.0051020407f * fConst0)) + -0.8f)));
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->openHorizontalBox("1-GLOBAL");
		...
		ui_interface->addVerticalSlider("Pitch_Shift", &fVslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(12.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider1, "4", "");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Drive", &fVslider1, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider0, "5", "");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Tone", &fVslider0, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider9, "6", "");
		ui_interface->declare(&fVslider9, "style", "knob");
		ui_interface->addVerticalSlider("Reverb", &fVslider9, FAUSTFLOAT(0.15f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("2-CORDES");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec10[0] = fSlow0 + fConst2 * fRec10[1];
			float fTemp0 = std::tan(fConst3 * (4e+03f * fRec10[0] + 5e+02f));
			float fTemp1 = 1.0f / fTemp0;
			float fTemp2 = (fTemp1 + 1.4142135f) / fTemp0 + 1.0f;
			fRec12[0] = fSlow1 + fConst2 * fRec12[1];
			iRec14[0] = 1103515245 * iRec14[1] + 12345;
			float fTemp3 = static_cast<float>(iRec14[0]);
			fRec16[0] = fSlow2 + fConst2 * fRec16[1];
			float fTemp4 = std::pow(2.0f, 0.083333336f * fRec16[0]);
			fRec17[0] = fSlow3 + fConst2 * fRec17[1];
			float fTemp5 = std::max<float>(1.0f, fRec17[0] * fTemp4);
			fVec0[0] = fSlow4;
			fRec15[0] = fRec15[1] + static_cast<float>((fSlow4 - fVec0[1]) > 0.0f) - fConst4 * fTemp5 * static_cast<float>(fRec15[1] > 0.0f);
			fVec1[IOTA0 & 8191] = 0.5f * (fSlow7 * fRec13[1] + fSlow6 * fRec13[2]) * std::pow(0.001f, 0.25f / fTemp5) + 4.656613e-10f * static_cast<float>(fRec15[0] > 0.0f) * fTemp3;
			fRec13[0] = fVec1[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, fConst0 / fTemp5 + -1.0f)))) & 8191];
			fRec20[0] = fSlow8 + fConst2 * fRec20[1];
			float fTemp6 = std::max<float>(1.0f, fRec20[0] * fTemp4);
			fVec2[0] = fSlow9;
			fRec19[0] = fRec19[1] + static_cast<float>((fSlow9 - fVec2[1]) > 0.0f) - fConst4 * fTemp6 * static_cast<float>(fRec19[1] > 0.0f);
			fVec3[IOTA0 & 8191] = 0.5f * (fSlow7 * fRec18[1] + fSlow6 * fRec18[2]) * std::pow(0.001f, 0.25f / fTemp6) + 4.656613e-10f * fTemp3 * static_cast<float>(fRec19[0] > 0.0f);
			fRec18[0] = fVec3[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, fConst0 / fTemp6 + -1.0f)))) & 8191];
			fRec23[0] = fSlow10 + fConst2 * fRec23[1];
			float fTemp7 = std::max<float>(1.0f, fRec23[0] * fTemp4);
			fVec4[0] = fSlow11;
			fRec22[0] = fRec22[1] + static_cast<float>((fSlow11 - fVec4[1]) > 0.0f) - fConst4 * fTemp7 * static_cast<float>(fRec22[1] > 0.0f);
			fVec5[IOTA0 & 8191] = 0.5f * (fSlow7 * fRec21[1] + fSlow6 * fRec21[2]) * std::pow(0.001f, 0.25f / fTemp7) + 4.656613e-10f * fTemp3 * static_cast<float>(fRec22[0] > 0.0f);
			fRec21[0] = fVec5[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, fConst0 / fTemp7 + -1.0f)))) & 8191];
			fRec26[0] = fSlow12 + fConst2 * fRec26[1];
			float fTemp8 = std::max<float>(1.0f, fRec26[0] * fTemp4);
			fVec6[0] = fSlow13;
			fRec25[0] = fRec25[1] + static_cast<float>((fSlow13 - fVec6[1]) > 0.0f) - fConst4 * fTemp8 * static_cast<float>(fRec25[1] > 0.0f);
			fVec7[IOTA0 & 8191] = 0.5f * (fSlow7 * fRec24[1] + fSlow6 * fRec24[2]) * std::pow(0.001f, 0.25f / fTemp8) + 4.656613e-10f * fTemp3 * static_cast<float>(fRec25[0] > 0.0f);
			fRec24[0] = fVec7[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, fConst0 / fTemp8 + -1.0f)))) & 8191];
			fRec29[0] = fSlow14 + fConst2 * fRec29[1];
			float fTemp9 = std::max<float>(1.0f, fRec29[0] * fTemp4);
			fVec8[0] = fSlow15;
			fRec28[0] = fRec28[1] + static_cast<float>((fSlow15 - fVec8[1]) > 0.0f) - fConst4 * fTemp9 * static_cast<float>(fRec28[1] > 0.0f);
			fVec9[IOTA0 & 8191] = 0.5f * (fSlow7 * fRec27[1] + fSlow6 * fRec27[2]) * std::pow(0.001f, 0.25f / fTemp9) + 4.656613e-10f * fTemp3 * static_cast<float>(fRec28[0] > 0.0f);
			fRec27[0] = fVec9[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, fConst0 / fTemp9 + -1.0f)))) & 8191];
			fRec11[0] = tanhf((fRec27[0] + fRec24[0] + fRec21[0] + fRec18[0] + fRec13[0]) * (15.0f * fRec12[0] + 1.0f)) - (fRec11[2] * ((fTemp1 + -1.4142135f) / fTemp0 + 1.0f) + 2.0f * fRec11[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp0))) / fTemp2;
			float fTemp10 = (fRec11[2] + fRec11[0] + 2.0f * fRec11[1]) / fTemp2;
			fVec10[0] = fTemp10;
			fRec9[0] = -(fConst7 * (fConst6 * fRec9[1] - fConst5 * (fTemp10 - fVec10[1])));
			fRec30[0] = fSlow16 + fConst2 * fRec30[1];
			fRec31[0] = 0.4f * fRec31[1] + 0.6f * fRec8[1];
			fVec11[IOTA0 & 8191] = fRec31[0] * fRec30[0] + fRec9[0];
			fRec8[0] = fVec11[(IOTA0 - iConst8) & 8191];
			fRec33[0] = 0.4f * fRec33[1] + 0.6f * fRec32[1];
			fVec12[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec33[0];
			fRec32[0] = fVec12[(IOTA0 - iConst9) & 8191];
			fRec35[0] = 0.4f * fRec35[1] + 0.6f * fRec34[1];
			fVec13[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec35[0];
			fRec34[0] = fVec13[(IOTA0 - iConst10) & 8191];
			fRec37[0] = 0.4f * fRec37[1] + 0.6f * fRec36[1];
			fVec14[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec37[0];
			fRec36[0] = fVec14[(IOTA0 - iConst11) & 8191];
			fRec39[0] = 0.4f * fRec39[1] + 0.6f * fRec38[1];
			fVec15[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec39[0];
			fRec38[0] = fVec15[(IOTA0 - iConst12) & 8191];
			fRec41[0] = 0.4f * fRec41[1] + 0.6f * fRec40[1];
			fVec16[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec41[0];
			fRec40[0] = fVec16[(IOTA0 - iConst13) & 8191];
			fRec43[0] = 0.4f * fRec43[1] + 0.6f * fRec42[1];
			fVec17[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec43[0];
			fRec42[0] = fVec17[(IOTA0 - iConst14) & 8191];
			fRec45[0] = 0.4f * fRec45[1] + 0.6f * fRec44[1];
			fVec18[IOTA0 & 8191] = fRec9[0] + fRec30[0] * fRec45[0];
			fRec44[0] = fVec18[(IOTA0 - iConst15) & 8191];
			float fTemp11 = fRec44[1] + fRec42[1] + fRec40[1] + fRec38[1] + fRec36[1] + fRec34[1] + fRec32[1] + 0.5f * fRec6[1] + fRec8[1];
			fVec19[IOTA0 & 2047] = fTemp11;
			fRec6[0] = fVec19[(IOTA0 - iConst16) & 2047];
			float fRec7 = -(0.5f * fTemp11);
			float fTemp12 = fRec6[1] + fRec7 + 0.5f * fRec4[1];
			fVec20[IOTA0 & 2047] = fTemp12;
			fRec4[0] = fVec20[(IOTA0 - iConst17) & 2047];
			float fRec5 = -(0.5f * fTemp12);
			float fTemp13 = fRec4[1] + fRec5 + 0.5f * fRec2[1];
			fVec21[IOTA0 & 2047] = fTemp13;
			fRec2[0] = fVec21[(IOTA0 - iConst18) & 2047];
			float fRec3 = -(0.5f * fTemp13);
			float fTemp14 = fRec2[1] + fRec3 + 0.5f * fRec0[1];
			fVec22[IOTA0 & 1023] = fTemp14;
			fRec0[0] = fVec22[(IOTA0 - iConst19) & 1023];
			float fRec1 = -(0.5f * fTemp14);
			fRec46[0] = fSlow17 + fConst2 * fRec46[1];
			float fTemp15 = fRec46[0] * (fRec1 + fRec0[1]);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp15);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp15);
			fRec10[1] = fRec10[0];
			fRec12[1] = fRec12[0];
			iRec14[1] = iRec14[0];
			fRec16[1] = fRec16[0];
	...
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Master", fVslider10, -6.0f, -6e+01f, 0.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Timbre", fVslider4, 0.5f, 0.1f, 0.98f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Pitch_Shift", fVslider2, 0.0f, 0.0f, 12.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Drive", fVslider1, 0.3f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Tone", fVslider0, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/1-GLOBAL/Reverb", fVslider9, 0.15f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/2-CORDES/Corde_1/frequence", fVslider8, 82.41f, 5.0f, 8.8e+02f, 0.1f);
	FAUST_ADDBUTTON("KISANA_GUITAR/2-CORDES/Corde_1/pincer", fButton4);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/2-CORDES/Corde_2/frequence", fVslider7, 1.1e+02f, 5.0f, 8.8e+02f, 0.1f);
	FAUST_ADDBUTTON("KISANA_GUITAR/2-CORDES/Corde_2/pincer", fButton3);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/2-CORDES/Corde_3/frequence", fVslider6, 146.83f, 5.0f, 8.8e+02f, 0.1f);
	FAUST_ADDBUTTON("KISANA_GUITAR/2-CORDES/Corde_3/pincer", fButton2);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/2-CORDES/Corde_4/frequence", fVslider5, 196.0f, 5.0f, 8.8e+02f, 0.1f);
	FAUST_ADDBUTTON("KISANA_GUITAR/2-CORDES/Corde_4/pincer", fButton1);
	FAUST_ADDVERTICALSLIDER("KISANA_GUITAR/2-CORDES/Corde_5/frequence", fVslider3, 246.94f, 5.0f, 8.8e+02f, 0.1f);
	FAUST_ADDBUTTON("KISANA_GUITAR/2-CORDES/Corde_5/pincer", fButton0);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, Master, "KISANA_GUITAR/1-GLOBAL/Master", fVslider10, -6.0f, -6e+01f, 0.0f, 0.01f) \
		p(VERTICALSLIDER, Timbre, "KISANA_GUITAR/1-GLOBAL/Timbre", fVslider4, 0.5f, 0.1f, 0.98f, 0.01f) \
		p(VERTICALSLIDER, Pitch_Shift, "KISANA_GUITAR/1-GLOBAL/Pitch_Shift", fVslider2, 0.0f, 0.0f, 12.0f, 0.01f) \
		p(VERTICALSLIDER, Drive, "KISANA_GUITAR/1-GLOBAL/Drive", fVslider1, 0.3f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, Tone, "KISANA_GUITAR/1-GLOBAL/Tone", fVslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, Reverb, "KISANA_GUITAR/1-GLOBAL/Reverb", fVslider9, 0.15f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, frequence, "KISANA_GUITAR/2-CORDES/Corde_1/frequence", fVslider8, 82.41f, 5.0f, 8.8e+02f, 0.1f) \
		p(BUTTON, pincer, "KISANA_GUITAR/2-CORDES/Corde_1/pincer", fButton4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(VERTICALSLIDER, frequence, "KISANA_GUITAR/2-CORDES/Corde_2/frequence", fVslider7, 1.1e+02f, 5.0f, 8.8e+02f, 0.1f) \
		p(BUTTON, pincer, "KISANA_GUITAR/2-CORDES/Corde_2/pincer", fButton3, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(VERTICALSLIDER, frequence, "KISANA_GUITAR/2-CORDES/Corde_3/frequence", fVslider6, 146.83f, 5.0f, 8.8e+02f, 0.1f) \
		p(BUTTON, pincer, "KISANA_GUITAR/2-CORDES/Corde_3/pincer", fButton2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(VERTICALSLIDER, frequence, "KISANA_GUITAR/2-CORDES/Corde_4/frequence", fVslider5, 196.0f, 5.0f, 8.8e+02f, 0.1f) \
		p(BUTTON, pincer, "KISANA_GUITAR/2-CORDES/Corde_4/pincer", fButton1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(VERTICALSLIDER, frequence, "KISANA_GUITAR/2-CORDES/Corde_5/frequence", fVslider3, 246.94f, 5.0f, 8.8e+02f, 0.1f) \
		p(BUTTON, pincer, "KISANA_GUITAR/2-CORDES/Corde_5/pincer", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
